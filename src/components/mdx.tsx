...
// Removed ComponentPreview and ComponentSource - not needed without registry
import {
  Table,
  TableBody,
  TableCell,
...
// Removed rehype-component import - not needed without registry
...
const components: MDXRemoteProps["components"] = {
  ...
  code: Code,
  // Removed ComponentPreview and ComponentSource
